...
//		System.out.printf("%s\t%d\t%d\t%d\t%d\t%.2f\n",s[0].name,s[0].kor,s[0].eng,s[0].math,s[0].total,s[0].avg);
//		System.out.printf("%s\t%d\t%d\t%d\t%d\t%.2f\n",s[1].name,s[1].kor,s[1].eng,s[1].math,s[1].total,s[1].avg);
//		System.out.printf("%s\t%d\t%d\t%d\t%d\t%.2f\n",s[2].name,s[2].kor,s[2].eng,s[2].math,s[2].total,s[2].avg);
