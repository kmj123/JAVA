...
public class StuDeck {
	...
	public void stu_FileRead(ArrayList<Student> list) throws Exception {
		...
		br.close();
		fr.close();
		System.out.println("[ c:/aaa/stu.txt 파일 읽어오기 성공 ] ");
		System.out.println();
	}//stuFileRead
	...
	public void stu_update(ArrayList<Student> list) {
		...
		if(temp==1) {
			...
			System.out.println("----------------------------");
			System.out.println("수정하려는 과목 번호를 선택해주세요>>");
			choice = scan.nextInt();
			...
			System.out.printf("%s으로 검색된 이름이 없습니다.\n",name);
	...
	public void stu_delete(ArrayList<Student> list) {
		...
		if(temp==1) {
			System.out.println();
			System.out.printf("[삭제학생 검색완료]");
			System.out.printf("%s 학생이 검색되었습니다.\s",name);
			...
			case 1:
				...
				System.out.println("% 학생성적이 삭제되었습니다\n");
				System.out.println();
				break;
			case 2: 
				System.out.println("[ 학생성적 취소완료 ]");
				System.out.println("% 학생 성적 삭제가 취소되었습니다.\n");
				break;
			}
		} else {
			System.out.printf("%s 학생생이 없습니다. 다시 입력하세요!");
		}
	}// stu_delete
	...
	public void sort_total(ArrayList<Student> list) {
		...
		System.out.println("1. 합계 순차 정렬");
		System.out.println("2. 합계 역순 정렬");
		System.out.println("0. 정렬 취소");
		System.out.println("-------------------------");
		System.out.println("원하는 번호를 입력하세요");
		choice = scan.nextInt();
	...
	// 8. 번호 정렬
	public void sort_number(ArrayList<Student> list) {
		System.out.println("[ 번호 정렬 ]");
		System.out.println("1. 번호 순차 정렬");
		System.out.println("2. 번호 역순 정렬");
		System.out.println("0. 정렬 취소");
		System.out.println("-------------------------");
		System.out.println("원하는 번호를 입력하세요");
		choice = scan.nextInt();
	...
	// 9. 학생성적 파일저장 메소드 //파일저장 - true:이어쓰기, false:덮어쓰기
